...
"[project]/app/api/v1/users/verify-email/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const POST = async (req)=>{
    ...
    if (Object.keys(userData).length == 0) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$ApiError$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"])(401, "Invalid token");
    }
    const user = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].create({
        firstName: userData.firstName,
        lastName: userData.lastName,
        password: userData.password,
        email: userData.email,
        college: new __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].Types.ObjectId(userData.collegeId)
    });
    const createdUser = await __TURBOPACK__imported__module__$5b$project$5d2f$models$2f$user$2e$model$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].findById(user?.id).select('-password');
    if (!createdUser) {
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$ApiError$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiError"])(500, "Error while creating user document");
    }
    await redisClient.del(`users:signup:${token}`);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$utils$2f$ApiResponse$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["ApiResponse"])(201, "User created successfully", createdUser);
};
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__8cd2871e._.js.map